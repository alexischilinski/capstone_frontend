...
class Form extends Component {
    ...
    handleClick = (event) => {
        if (this.props.userRaces){
            if (event.target.className === "race-button"){
                ...
                const findUserRace = this.props.userRaces.find(userRace =>
    ...
    handleSubmit = (event) => {
        if (event.target.className === "signup"){
            ...
            event.preventDefault()
            this.props.updatePhotoFunction(
                this.props.photos["id"], 
                this.state.photo
            )
                ...
                <div>
                    <form 
                        ...
                        <div 
                            ...
                            <div 
                                onClick={this.handleClick} 
                                className={this.state.distance === "5k"
                            ...
                            <div
                                onClick={this.handleClick} 
                                className={this.state.distance === "10k"
                                ? "selected-race-button" 
                                : "race-button"} 
                                value="10k"
                                >10k
                            ...
                            <div 
                                onClick={this.handleClick} 
                                className={this.state.distance === "half marathon"
                                ? "selected-race-button" 
                                : "race-button"} 
                                value="half marathon"
                                >Half Marathon
                            ...
                            <div 
                                onClick={this.handleClick} 
                                className={this.state.distance === "full marathon" 
                                ? "selected-race-button" 
                                : "race-button"} 
                                value="full marathon"
                                >Full Marathon
